  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col">
      ...
      <div className="flex flex-col flex-1 w-full p-0 m-0 sm:hidden">
        ...
        <div className="w-full flex flex-col items-center justify-center gap-6 p-8  z-10">
          <div className="w-3/4 p-6 text-center rounded-md shadow-md bg-white">
            <h2 className="text-2xl font-bold text-sun mb-2">
      ...
      <div className="hidden sm:block h-full w-full">
        <div
          ref={deskHeroRef}
          className="h-[20vh] flex flex-row items-center justify-center p-4 text-[8vh] font-bold leading-tight z-10 gap-[1vw] "
        >
          <div className={`${isVisible ? "animate-slide-in-1" : "opacity-0"} `}>
            Our
          </div>
          <div
            className={`${isVisible ? "animate-slide-in-2" : "opacity-0"}  flex text-sun`}
          >
            Services
          </div>
        </div>
        ...
        <div className="w-full h-[60vh] flex flex-col items-center justify-center gap-[3vh] p-8  z-10">
          <div className="h-[20vh] w-[40vw] p-6 text-center rounded-[2vh] shadow-md bg-white z-10">
            ...
            <p className="text-[2vh] text-wrap">
              Complete solar panel setup tailored to your home.
            </p>
          </div>
          ...
          <div className="h-[20vh] w-[40vw] p-6 text-center  rounded-[2vh] shadow-md bg-white z-10">
            ...
            <p className="text-[2vh] text-wrap">
              Tesla Powerwall and general battery backup systems.
            </p>
          </div>
          ...
          <div className="h-[20vh] w-[40vw] p-6 text-center rounded-[2vh] shadow-md bg-white z-10">
            ...
            <p className="text-[2vh] text-wrap">
              Annual checkups to keep your system at maximum efficiency.
            </p>
          </div>
        </div>
