...
export default function Home() {
  return (
    <div className="min-w-screen p-0 m-0">
        ...
        <div className="bg-white h-140 w-screen  justify-center items-center flex flex-col gap-4"
             style={{
        ...
        <div className="bg-green-500 h-120 justify-center items-center flex flex-col gap-4">
          <div className=" w-2/3 p-3 text-center text-xl">Save Money</div>
          <div>and enjoy a</div>
          <div className=" w-2/3 p-3 text-center text-xl">25-Year Warranty</div>
          <div>while staying</div>
          <div className=" w-2/3 p-3 text-center text-xl">Eco-Friendly</div>
          <div>with</div>
          <div>
            <div>Lumina</div>
            <div>Solar</div>
